...
const (
	// Basic version information including scaling and inbound channels,
...
type ListServicesResponse struct {
	// The channels belonging to the requested application.
	Services []*Service `protobuf:"bytes,1,rep,name=channels,proto3" json:"channels,omitempty"`
	// Continuation token for fetching the next page of results.
...
type GetServiceRequest struct {
	// Name of the resource requested. Example: `apps/myapp/channels/default`.
	Name                 string   `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
type UpdateServiceRequest struct {
	// Name of the resource to update. Example: `apps/myapp/channels/default`.
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
...
type GetVersionRequest struct {
	...
	// `apps/myapp/channels/default/versions/v1`.
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
...
type UpdateVersionRequest struct {
	...
	// `apps/myapp/channels/default/versions/1`.
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
...
type GetInstanceRequest struct {
	// Name of the resource requested. Example:
	// `apps/myapp/channels/default/versions/v1/instances/instance-1`.
	Name                 string   `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
type ServicesClient interface {
	// Lists all the channels in the application.
