...
type AddonsConfig struct {
	...
	// makes it easy to set up HTTP load balancers for channels in a cluster.
...
// which makes it easy to set up HTTP load balancers for channels in a cluster.
...
type IPAllocationPolicy struct {
	...
	// The name of the secondary range to be used as for the channels
	...
	// The IP address range of the channels IPs in this cluster. If blank, a range
...
type Cluster struct {
	...
	// [Output only] The IP address range of the Kubernetes channels in
	// this cluster, in
	// [CIDR](http://en.wikipedia.org/wiki/Classless_Inter-Domain_Routing)
...
// NodeManagement defines the set of node management channels turned on for the
// node pool.
