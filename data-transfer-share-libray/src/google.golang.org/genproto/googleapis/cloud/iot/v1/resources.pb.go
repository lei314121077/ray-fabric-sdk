...
// The api authorization/authentication method. This setting determines how
// Cloud IoT Core authorizes/authenticate devices to access the api.
...
const (
	...
	// The device is authenticated through the api association only. Device
	...
	// The device is authenticated through both device credentials and api
	// association. The device must be bound to the api and must provide its
	// own credentials.
...
type GatewayConfig struct {
	// Indicates whether the device is a api.
	...
	// [Output only] The ID of the api the device accessed most recently.
	...
	// [Output only] The most recent time at which the device accessed the api
