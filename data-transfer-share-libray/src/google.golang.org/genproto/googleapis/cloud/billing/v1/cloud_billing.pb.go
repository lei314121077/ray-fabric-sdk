...
type BillingAccount struct {
	...
	// therefore projects associated with it will be unable to use paid channels.
...
type ProjectBillingInfo struct {
	...
	// use paid channels. This field is read-only.
...
type CloudBillingClient interface {
	...
	// in-use channels will stop, and your application could stop functioning as
