...
type WebhookResponse struct {
	...
	// (e.g., Actions on Google or Dialogflow phone api) use this information
...
type OriginalDetectIntentRequest struct {
	...
	//
	// This field is used for the telephony api. It should have a
	...
	// telephony api is used with a standard tier agent the `caller_id` field
