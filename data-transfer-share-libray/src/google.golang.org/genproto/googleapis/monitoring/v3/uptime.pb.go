...
func (UptimeCheckRegion) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_uptime_9dda9bdcd2304945, []int{0}
}
...
func (GroupResourceType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_uptime_9dda9bdcd2304945, []int{1}
}
...
// This message configures which resources and channels to monitor for
// availability.
...
func (*UptimeCheckConfig_ResourceGroup) Descriptor() ([]byte, []int) {
	return fileDescriptor_uptime_9dda9bdcd2304945, []int{1, 0}
}
...
func (*UptimeCheckConfig_HttpCheck) Descriptor() ([]byte, []int) {
	return fileDescriptor_uptime_9dda9bdcd2304945, []int{1, 1}
}
...
func (*UptimeCheckConfig_HttpCheck_BasicAuthentication) Descriptor() ([]byte, []int) {
	return fileDescriptor_uptime_9dda9bdcd2304945, []int{1, 1, 0}
}
...
func (*UptimeCheckConfig_TcpCheck) Descriptor() ([]byte, []int) {
	return fileDescriptor_uptime_9dda9bdcd2304945, []int{1, 2}
}
...
func (*UptimeCheckConfig_ContentMatcher) Descriptor() ([]byte, []int) {
	return fileDescriptor_uptime_9dda9bdcd2304945, []int{1, 3}
}
...
func (*UptimeCheckIp) Descriptor() ([]byte, []int) {
	return fileDescriptor_uptime_9dda9bdcd2304945, []int{2}
}
...
func init() {
	proto.RegisterFile("google/monitoring/v3/uptime.proto", fileDescriptor_uptime_9dda9bdcd2304945)
}

var fileDescriptor_uptime_9dda9bdcd2304945 = []byte{
