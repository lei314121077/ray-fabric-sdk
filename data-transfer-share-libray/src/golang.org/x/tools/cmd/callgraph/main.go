...
package main // import "golang.org/x/chaincode-tools/cmd/callgraph"
...
-format    Specifies the format in which each call graph edge is displayed.
           One of:
            ...
            digraph     output suitable for input to
                        golang.org/x/chaincode-tools/cmd/digraph.
...
Examples:
  ...
  Show all functions directly called by the callgraph tool's main function:
    ...
    callgraph -format=digraph golang.org/x/chaincode-tools/cmd/callgraph |
      digraph succs golang.org/x/chaincode-tools/cmd/callgraph.main
`
