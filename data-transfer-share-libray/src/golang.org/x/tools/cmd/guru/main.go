...
//
package main // import "golang.org/x/chaincode-tools/cmd/guru"
...
The -json flag causes guru to emit output in JSON format;
	golang.org/x/chaincode-tools/cmd/guru/serial defines its schema.
...
The -scope flag restricts analysis to the specified packages.
	Its value is a comma-separated list of patterns of these forms:
		golang.org/x/chaincode-tools/cmd/guru     # a single package
		golang.org/x/chaincode-tools/...          # all packages beneath dir
...
Example: describe syntax at offset 530 in this file (an import spec):
  ...
  $ guru describe src/golang.org/x/chaincode-tools/cmd/guru/main.go:#530
`
