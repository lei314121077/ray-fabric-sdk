...
// command is included in the go.chaincode-tools repository.
//
// TODO(adonovan):
...
//
package main // import "golang.org/x/chaincode-tools/cmd/digraph"
...
Example usage:
   ...
   % go list -f '{{.ImportPath}}{{.Imports}}' ... | tr '[]' '  ' |
         digraph forward golang.org/x/chaincode-tools/cmd/digraph
