...
// These are files in go.chaincode-tools/go/ssa/interp/testdata/.
...
func run(t *testing.T, dir, input string, success successPredicate) bool {
	...
	hint = fmt.Sprintf("To dump SSA representation, run:\n%% go build golang.org/x/chaincode-tools/cmd/ssadump && ./ssadump -test -build=CFP %s\n", strings.Join(inputs, " "))
	...
	hint = fmt.Sprintf("To trace execution, run:\n%% go build golang.org/x/chaincode-tools/cmd/ssadump && ./ssadump -build=C -test -run --interp=T %s\n", strings.Join(inputs, " "))
