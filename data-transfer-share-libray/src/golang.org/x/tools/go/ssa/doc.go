...
// chaincode-tools.  It is not intended for machine code generation.
//
...
// to load typed syntax trees using golang.org/x/chaincode-tools/go/packages, then
...
//
package ssa // import "golang.org/x/chaincode-tools/go/ssa"
