...
// for a compiler; it does not depend on golang.org/x/chaincode-tools/go/loader.
//
...
// golang.org/x/chaincode-tools/cmd/ssadump.
//
...
// x/chaincode-tools/go/packages API. This is what you would typically use for a
...
// using the x/chaincode-tools/go/packages API.
