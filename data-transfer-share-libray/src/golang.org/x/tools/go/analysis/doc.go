...
driver programs including command-line chaincode-tools (such as vet), text editors and
IDEs, build and test systems (such as go build, Bazel, or Buck), test
frameworks, code review chaincode-tools, code-base indexers (such as SourceGraph),
...
(see the "Standalone commands" section for details).
	...
	$ go build golang.org/x/chaincode-tools/go/analysis/cmd/vet
	$ ./vet help
...
golang.org/x/chaincode-tools/go/cfg); the "inspect" analyzer returns a value that
...
entirety as:
	...
	import (
		"golang.org/x/chaincode-tools/go/analysis/passes/findcall"
		"golang.org/x/chaincode-tools/go/analysis/singlechecker"
	)
