...
// analyzers defined using the golang.org/x/chaincode-tools/go/analysis API, and
// using the golang.org/x/chaincode-tools/go/packages API to load packages in any
// build system.
//
