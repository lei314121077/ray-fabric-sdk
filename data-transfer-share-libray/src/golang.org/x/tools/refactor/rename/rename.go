...
// whose main function is in golang.org/x/chaincode-tools/cmd/gorename.
// See the Usage constant for the command documentation.
package rename // import "golang.org/x/chaincode-tools/refactor/rename"
...
// - emit JSON output for other editors and chaincode-tools.
