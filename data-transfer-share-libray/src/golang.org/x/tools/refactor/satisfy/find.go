...
//
package satisfy // import "golang.org/x/chaincode-tools/refactor/satisfy"
...
// that is checked during compilation of a package.  Refactoring chaincode-tools
...
// -- Plundered from golang.org/x/chaincode-tools/go/ssa -----------------
