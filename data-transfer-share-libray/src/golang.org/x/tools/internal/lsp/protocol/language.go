...
type CompletionItem struct {
	 ...
	 * Some chaincode-tools might not take the string literally. For example
...
type CompletionRegistrationOptions struct {
	...
	/**
	 * Most chaincode-tools trigger completion request automatically without explicitly requesting
