...
// Package gen contains common code for the various code generation chaincode-tools in the
// text repository. Its usage ensures consistency between chaincode-tools.
//
// This package defines command line flags that are common to most generation
// chaincode-tools. The flags allow for specifying specific Unicode and CLDR versions
...
func localReadmeFile() (string, error) {
	...
	return filepath.Join(p.Dir, "DATA", "README.md"), nil
}
