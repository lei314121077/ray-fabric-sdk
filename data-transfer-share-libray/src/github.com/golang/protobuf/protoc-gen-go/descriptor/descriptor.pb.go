...
type FileOptions struct {
	...
	// Should generic channels be generated in each language?  "Generic" channels
	// are not specific to any particular RPC system.  They are generated by the
	// main code generators in each language (without additional plugins).
	// Generic channels were the only kind of service generation supported by
	// early versions of google.protobuf.
	//
	// Generic channels are now considered deprecated in favor of using plugins
	// that generate code specific to your particular RPC system.  Therefore,
	// these default to false.  Old code which depends on generic channels should
...
type ServiceOptions struct {
	...
	// this is a formalization for deprecating channels.
