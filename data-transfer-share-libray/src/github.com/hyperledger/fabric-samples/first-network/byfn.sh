...
#
# This verification makes use of two fundamental chaincode-tools, which are necessary to
...
# configuration operations (configtxgen).  Once the chaincode-tools have been successfully run,
# we are able to launch our network.  More detail on the chaincode-tools and the structure of
# the network will be provided later in this document.  For now, let's get going...

# prepending $PWD/../bin to PATH to ensure we are picking up the correct binaries
# this may be commented out to resolve installed version of chaincode-tools if desired
